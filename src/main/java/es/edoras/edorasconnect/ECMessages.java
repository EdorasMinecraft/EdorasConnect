...
public enum ECMessages {
    ...
    MINECRAFT_DISCORD_USER_UNKNOWN_MESSAGE("minecraft.discord.user-unknown-message", "{prefix} &#00eaba{user}&f ha adjuntado el archivo {file}. &f{message}"),
    MINECRAFT_DISCORD_USER_MUTED("minecraft.discord.user-muted", "{prefix} &#7289DA{user} se ha muteado."),
    MINECRAFT_DISCORD_USER_UNMUTED("minecraft.discord.user-unmuted", "{prefix} &#7289DA{user} se ha desmuteado."),
    MINECRAFT_DISCORD_USER_DEAFEN("minecraft.discord.user-deafen", "{prefix} &#7289DA{user} se ha ensordecido."),
    MINECRAFT_DISCORD_USER_UNDEAFEN("minecraft.discord.user-undeafen", "{prefix} &#7289DA{user} se ha desensordecido."),
    MINECRAFT_DISCORD_USER_STREAM_ON("minecraft.discord.user-stream-on", "{prefix} &#7289DA{user} ha empezado a retransmitir."),
    MINECRAFT_DISCORD_USER_STREAM_OFF("minecraft.discord.user-stream-off", "{prefix} &#7289DA{user} ha cerrado su retransmisión."),
    MINECRAFT_DISCORD_USER_VIDEO_ON("minecraft.discord.user-video-on", "{prefix} &#7289DA{user} ha encendido su cámara."),
    MINECRAFT_DISCORD_USER_VIDEO_OFF("minecraft.discord.user-video-off", "{prefix} &#7289DA{user} ha apagado su cámara."),
